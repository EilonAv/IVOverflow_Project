...
const NewQuestion = function(props) {
    ...
    const validateForm = function () {
        return newQuestionTitle.length > 0 && newQuestionContent.length > 0 && newQuestionTags.length > 0;
    }
    ...
    <div className="newQuestion">
        <Button onClick={ () => {setShow(true)}}>Ask Question</Button>
        <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Footer>
                <Button variant="primary" size="lg" className="submit_newQuestion" onClick={handleSubmit} disabled={!validateForm() }>
                Submit 
                </Button>
            </Modal.Footer>
        </Modal>
